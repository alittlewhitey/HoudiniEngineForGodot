...
#include "Utility.h"
HE_ENUM_CAST(HAPI_AttributeTypeInfo)
HE_ENUM_CAST(HAPI_AttributeOwner)
HE_ENUM_CAST(HAPI_NodeType)
HE_ENUM_CAST(HAPI_GeoType)
HE_ENUM_CAST(HAPI_PartType)
HE_ENUM_CAST(HAPI_ParmType)
HE_ENUM_CAST(HAPI_InputType)
HE_ENUM_CAST(HAPI_CurveType)
HE_ENUM_CAST(HAPI_Result)
HE_ENUM_CAST(HAPI_NodeFlags)
HE_ENUM_CAST(HAPI_StorageType)
HE_ENUM_CAST(HAPI_PrmScriptType)
HE_ENUM_CAST(HAPI_StatusVerbosity)
HE_ENUM_CAST(HAPI_StatusType)
HE_ENUM_CAST(HAPI_RampType)
HE_ENUM_CAST(HAPI_RSTOrder)
HE_ENUM_CAST(HAPI_XYZOrder)
HE_ENUM_CAST(HAPI_TCP_PortType)
HE_ENUM_CAST(HAPI_ThriftSharedMemoryBufferType)
HE_ENUM_CAST(HAPI_Permissions)
HE_ENUM_CAST(HAPI_ChoiceListType)
HE_ENUM_CAST(HAPI_PackedPrimInstancingMode)
HE_ENUM_CAST(HAPI_InputCurveMethod)
HE_ENUM_CAST(HAPI_InputCurveParameterization)
