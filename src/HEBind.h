...
public:
    ...
    static godot::Dictionary GetObjectInfo(godot::Ref<HESession> session,int nodeId);
    static godot::Dictionary GetAssetInfo(godot::Ref<HESession> session, int nodeId);
    static godot::Dictionary GetNodeInfo(godot::Ref<HESession> session, int nodeId);
    static godot::Dictionary GetGeoInfo(godot::Ref<HESession> session, int nodeId);
    static godot::Dictionary GetMaterialInfo(godot::Ref<HESession> session, int nodeId);
    static godot::Dictionary GetPartInfo(godot::Ref<HESession> session, int nodeId, int partId);
    static godot::Dictionary GetAttrInfo(godot::Ref<HESession> session,int nodeId,int partId,godot::String name,HAPI_AttributeOwner owner);
    static godot::Dictionary GetParmInfo(godot::Ref<HESession> session,int nodeId,int parmId, godot::Ref<RefDictionary> parmInfo);
    static HAPI_Result AddAttribute(godot::Ref<HESession> session,int nodeId,int partId,godot::String name,godot::Ref<RefDictionary> attrInfo);
    static HAPI_Result Cleanup(godot::Ref<HESession> session);
    static HAPI_Result ClearConnectionError();
    static HAPI_Result CloseSession(godot::Ref<HESession> session);
    static HAPI_Result CommitGeo(godot::Ref<HESession> session,int nodeId);
    static HAPI_Result ConnectNodeInput(godot::Ref<HESession> session, int nodeId, int inputIndex, int nodeId_toConnect, int outputIndex);
    static HAPI_Result CookNode(godot::Ref<HESession> session, int nodeId, godot::Ref<RefDictionary> cookOptions);
    static godot::Dictionary CookOptions_Create();
    static HAPI_Result CreateInProcessSession(godot::Ref<HESession> session,godot::Ref<RefDictionary> sessionInfo);
    static HAPI_Result CreateInputNode(godot::Ref<HESession> session, int parentId, godot::Ref<Int> nodeId,godot::String name);
    static HAPI_Result CreateNode(godot::Ref<HESession> session, int parentId, godot::String operatorName, godot::String nodeLabel, bool cookOnCreation, godot::Ref<Int> nodeId);
    static HAPI_Result CreateThriftNamedPipeSession(godot::Ref<HESession> session, godot::String pipeName, godot::Ref<RefDictionary> sessionInfo);
    static HAPI_Result CreateThriftSharedMemorySession(godot::Ref<HESession> session, godot::String sharedMemName, godot::Ref<RefDictionary> sessionInfo);
    static HAPI_Result CreateThriftSocketSession(godot::Ref<HESession> session, godot::String hostName, int port, godot::Ref<RefDictionary> sessionInfo);
    static HAPI_Result DeleteAttribute(godot::Ref<HESession> session, int nodeId, int partId, godot::String name, godot::Ref<RefDictionary> attrInfo);
    static HAPI_Result DeleteNode(godot::Ref<HESession> session, int nodeId);
    static HAPI_Result DisconnectNodeInput(godot::Ref<HESession> session, int nodeId, int inputIndex);
    static godot::Dictionary GeoInfo_Create();
    static HAPI_Result GetAttributeFloatData(godot::Ref<HESession> session, int nodeId, int partId, godot::String name, godot::Ref<RefDictionary> attrInfo, int stride, godot::Ref<RefArray> dataArray, int start, int length);
    static HAPI_Result GetAttributeIntData(godot::Ref<HESession> session, int nodeId, int partId, godot::String name, godot::Ref<RefDictionary> attrInfo, int stride, godot::Ref<RefArray> dataArray, int start, int length);
    static HAPI_Result GetAttributeStringData(godot::Ref<HESession> session, int nodeId, int partId, godot::String name, godot::Ref<RefDictionary> attrInfo, godot::Ref<RefArray> dataArray, int start, int length);
    static godot::String GetConnectionError();
    static int GetCookingCurrentCount(godot::Ref<HESession> session);
    static int GetCookingTotalCount(godot::Ref<HESession> session);
    static godot::Dictionary GetDisplayGeoInfo(godot::Ref<HESession> session, int nodeId);
    static HAPI_Result GetInstanceTransformsOnPart(godot::Ref<HESession> session, int nodeId, int partId, HAPI_RSTOrder rst_order, godot::Ref<RefArray> transforms, int start, int length);
    static HAPI_Result GetInstancedObjectIds(godot::Ref<HESession> session, int nodeId, godot::Ref<RefArray> objectIds, int start, int length);
    static HAPI_Result GetInstancedPartIds(godot::Ref<HESession> session, int nodeId, int partId, godot::Ref<RefArray> partIds, int start, int length);
    ...
    static HAPI_Result GetNodeOutputName(godot::Ref<HESession> session, int nodeId, int outputIndex, godot::Ref<Int> nameHandle);
    static HAPI_Result GetNodePath(godot::Ref<HESession> session, int nodeId, int relativeToNodeId, godot::Ref<Int> pathHandle);
    static HAPI_Result GetObjectTransform(godot::Ref<HESession> session, int nodeId, int relativeToNodeId, HAPI_RSTOrder rst_order, godot::Ref<RefDictionary> transform);
    static HAPI_Result GetOutputGeoCount(godot::Ref<HESession> session, int nodeId, godot::Ref<Int> count);
    static HAPI_Result GetOutputGeoInfos(godot::Ref<HESession> session, int nodeId, godot::Ref<RefArray> geoInfos, int count);
    static HAPI_Result GetOutputNodeId(godot::Ref<HESession> session, int nodeId, int output, godot::Ref<Int> outputNodeId);
    static HAPI_Result GetParameters(godot::Ref<HESession> session, int nodeId, godot::Ref<RefArray> parameters, int start, int length);
    static HAPI_Result GetParmFloatValue(godot::Ref<HESession> session, int nodeId, godot::String parmName, int index, godot::Ref<Float> value);
    static HAPI_Result GetParmIdFromName(godot::Ref<HESession> session, int nodeId, godot::String parmName, godot::Ref<Int> parmId);
    static HAPI_Result GetParmIntValue(godot::Ref<HESession> session, int nodeId, godot::String parmName, int index, godot::Ref<Int> value);
    static HAPI_Result GetParmNodeValue(godot::Ref<HESession> session, int nodeId, godot::String parmName, godot::Ref<Int> value);
    static HAPI_Result GetParmStringValue(godot::Ref<HESession> session, int nodeId, godot::String parmName, int index, bool evaluate, godot::Ref<Int> value);
    static HAPI_Result GetStatus(godot::Ref<HESession> session, HAPI_StatusType statusType, godot::Ref<Int> status);
    static godot::String GetStatusString(godot::Ref<HESession> session, HAPI_StatusType status_type);
    static godot::String GetString(godot::Ref<HESession> session, int stringHandle);
    static HAPI_Result Initialize(godot::Ref<HESession> session, godot::Dictionary cookOptions, bool useCookingThread, int cookingThreadStackSize, godot::String houdiniEnvironmentFiles, godot::String otlSearchPath, godot::String dsoSearchPath, godot::String imageDsoSearchPath, godot::String audioDsoSearchPath);
    static HAPI_Result Interrupt(godot::Ref<HESession> session);
    static HAPI_Result IsInitialized(godot::Ref<HESession> session);
    static HAPI_Result IsSessionValid(godot::Ref<HESession> session);
    static HAPI_Result IsNodeValid(godot::Ref<HESession> session, int nodeId, int uniqueNodeId, godot::Ref<Bool> answer);
    static HAPI_Result LoadAssetLibraryFromFile(godot::Ref<HESession> session, godot::String filePath, bool allowOverwrite, godot::Ref<Int> assetId);
    static HAPI_Result LoadAssetLibraryFromMemory(godot::Ref<HESession> session, godot::String buffer, bool allowOverwrite, godot::Ref<Int> assetId);
    static HAPI_Result LoadGeoFromFile(godot::Ref<HESession> session, int nodeId, godot::String filePath);
    static HAPI_Result LoadGeoFromMemory(godot::Ref<HESession> session, int nodeId, godot::String format, godot::String buffer);
    static HAPI_Result LoadHIPFile(godot::Ref<HESession> session, godot::String fileName, bool cookOnLoad);
    static HAPI_Result LoadNodeFromFile(godot::Ref<HESession> session, godot::String fileName, int parentId, godot::String nodeLabel, bool cookOnLoad, godot::Ref<Int> newNodeId);
    ...
    static HAPI_Result RemoveCustomString(godot::Ref<HESession> session, int stringHandle);
    static HAPI_Result RenameNode(godot::Ref<HESession> session, int nodeId, godot::String newName);
    static HAPI_Result RevertGeo(godot::Ref<HESession> session, int nodeId);
    static HAPI_Result RevertParmToDefault(godot::Ref<HESession> session, int nodeId, godot::String parmName, int index);
    static HAPI_Result RevertParmToDefaults(godot::Ref<HESession> session, int nodeId, godot::String parmName);
    static HAPI_Result SaveGeoToFile(godot::Ref<HESession> session, int nodeId, godot::String filePath);
    static bool SaveToHip(godot::Ref<HESession> session, godot::String filename);
    static HAPI_Result SaveNodeToFile(godot::Ref<HESession> session, int nodeId, godot::String fileName);
    static HAPI_Result SetAttributeFloatData(godot::Ref<HESession> session, int nodeId, int partId, godot::String name, godot::Dictionary attrInfo, godot::Ref<RefArray> dataArray, int start, int length);
    static HAPI_Result SetAttributeIntData(godot::Ref<HESession> session, int nodeId, int partId, godot::String name, godot::Dictionary attrInfo, godot::Ref<RefArray> dataArray, int start, int length);
    static HAPI_Result SetAttributeStringData(godot::Ref<HESession> session, int nodeId, int partId, godot::String name, godot::Dictionary attrInfo, godot::Ref<RefArray> dataArray, int start, int length);
    static HAPI_Result SetCurveCounts(godot::Ref<HESession> session, int nodeId, int partId, godot::Array curveCounts, int start, int length);
    static HAPI_Result SetCurveInfo(godot::Ref<HESession> session, int nodeId, int partId, godot::Dictionary curveInfo);
    static HAPI_Result SetCurveKnots(godot::Ref<HESession> session, int nodeId, int partId, godot::Array knots, int start, int length);
    static HAPI_Result SetCurveOrders(godot::Ref<HESession> session, int nodeId, int partId, godot::Array orders, int start, int length);
    static HAPI_Result SetCustomString(godot::Ref<HESession> session, godot::String string_value, godot::Ref<Int> handle_value);
    static HAPI_Result SetFaceCounts(godot::Ref<HESession> session, int nodeId, int partId, godot::Array faceCounts, int start, int length);
    static HAPI_Result SetInputCurveInfo(godot::Ref<HESession> session, int nodeId, int partId, godot::Dictionary curveInfo);
    static HAPI_Result SetInputCurvePositions(godot::Ref<HESession> session, int nodeId, int partId, godot::Array positions, int start, int length);
    static HAPI_Result SetNodeDisplay(godot::Ref<HESession> session, int nodeId, int onOff);
    static HAPI_Result SetObjectTransform(godot::Ref<HESession> session, int nodeId, godot::Dictionary transform);
    static HAPI_Result SetServerEnvInt(godot::Ref<HESession> session, godot::String envName, int value);
    static HAPI_Result SetServerEnvString(godot::Ref<HESession> session, godot::String envName, godot::String value);
    static HAPI_Result SetSessionSync(godot::Ref<HESession> session, bool enable);
    static HAPI_Result SetSessionSyncInfo(godot::Ref<HESession> session, godot::Dictionary syncInfo);
};
#endif 