...
class HAPI: public godot::Object{
    ...
    static void _bind_methods(){
        ...
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("GetObjectInfo","session","nodeId"),&HAPI::GetObjectInfo);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("GetAssetInfo","session","nodeId"),&HAPI::GetAssetInfo);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("GetNodeInfo","session","nodeId"),&HAPI::GetNodeInfo);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("GetGeoInfo","session","nodeId"),&HAPI::GetGeoInfo);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("GetMaterialInfo","session","nodeId"),&HAPI::GetMaterialInfo);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("GetPartInfo","session","nodeId","partId"),&HAPI::GetPartInfo);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("GetAttrInfo","session","nodeId","partId","name","owner"),&HAPI::GetAttrInfo);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("GetParmInfo","session","nodeId","parmId","parmInfo"),&HAPI::GetParmInfo);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("AddAttribute","session","nodeId","partId","name","attrInfo"),&HAPI::AddAttribute);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("Cleanup","session"),&HAPI::Cleanup);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("ClearConnectionError"),&HAPI::ClearConnectionError);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("CloseSession","session"),&HAPI::CloseSession);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("CommitGeo","session","nodeId"),&HAPI::CommitGeo);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("ConnectNodeInput","session","nodeId","inputIndex","nodeId_toConnect","outputIndex"),&HAPI::ConnectNodeInput);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("CookNode","session","nodeId","cookOptions"),&HAPI::CookNode);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("CookOptions_Create"),&HAPI::CookOptions_Create);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("CreateInProcessSession","session","sessionInfo"),&HAPI::CreateInProcessSession);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("CreateInputNode","session","parentId","nodeId","name"),&HAPI::CreateInputNode);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("CreateNode","session","parentId","operatorName","nodeLabel","cookOnCreation","nodeId"),&HAPI::CreateNode);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("CreateThriftNamedPipeSession","session","pipeName","sessionInfo"),&HAPI::CreateThriftNamedPipeSession);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("CreateThriftSharedMemorySession","session","sharedMemName","sessionInfo"),&HAPI::CreateThriftSharedMemorySession);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("CreateThriftSocketSession","session","hostName","port","sessionInfo"),&HAPI::CreateThriftSocketSession);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("DeleteAttribute","session","nodeId","partId","name","attrInfo"),&HAPI::DeleteAttribute);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("DeleteNode","session","nodeId"),&HAPI::DeleteNode);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("DisconnectNodeInput","session","nodeId","inputIndex"),&HAPI::DisconnectNodeInput);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("GeoInfo_Create"),&HAPI::GeoInfo_Create);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("GetAttributeFloatData","session","nodeId","partId","name","owner"),&HAPI::GetAttributeFloatData);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("GetAttributeIntData","session","nodeId","partId","name","owner"),&HAPI::GetAttributeIntData);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("GetAttributeStringData","session","nodeId","partId","name","owner"),&HAPI::GetAttributeStringData);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("GetConnectionError"),&HAPI::GetConnectionError);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("GetCookingCurrentCount","session"),&HAPI::GetCookingCurrentCount);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("GetCookingTotalCount","session"),&HAPI::GetCookingTotalCount);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("GetDisplayGeoInfo","session","nodeId"),&HAPI::GetDisplayGeoInfo);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("GetInstanceTransformsOnPart","session","nodeId","partId","rst_order","transforms","start","length"),&HAPI::GetInstanceTransformsOnPart);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("GetInstancedObjectIds","session","nodeId","objectIds","start","length"),&HAPI::GetInstancedObjectIds);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("GetInstancedPartIds","session","nodeId","partId","partIds","start","length"),&HAPI::GetInstancedPartIds);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("GetInstancerPartTransforms", "session", "nodeId", "partId","rst_order","transforms","start","length"),&HAPI::GetInstancerPartTransforms);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("GetLastCookError","session"),&HAPI::GetLastCookError);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("GetLastError","session"),&HAPI::GetLastError);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("GetNodeCookResult","session","stringValue", "length"),&HAPI::GetNodeCookResult);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("GetNodeCookResultLength","session","nodeId","verbosity","length"),&HAPI::GetNodeCookResultLength);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("GetNodeFromPath","session","parentId","path","nodeId"),&HAPI::GetNodeFromPath);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("GetNodeInputName","session","nodeId","inputIndex","nameHandle"),&HAPI::GetNodeInputName);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("GetNodeOutputName","session","nodeId","outputIndex","nameHandle"),&HAPI::GetNodeOutputName);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("GetNodePath","session","nodeId","relativeToNodeId","pathHandle"),&HAPI::GetNodePath);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("GetObjectTransform","session","nodeId","relativeToNodeId","rst_order","transform"),&HAPI::GetObjectTransform);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("GetOutputGeoCount","session","nodeId","count"),&HAPI::GetOutputGeoCount);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("GetOutputGeoInfos","session","nodeId","geoInfos","count"),&HAPI::GetOutputGeoInfos);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("GetOutputNodeId","session","nodeId","output","outputNodeId"),&HAPI::GetOutputNodeId);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("GetParameters","session","nodeId","parameters","start","length"),&HAPI::GetParameters);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("GetParmFloatValue","session","nodeId","parmName","index","value"),&HAPI::GetParmFloatValue);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("GetParmIdFromName","session","nodeId","parmName","parmId"),&HAPI::GetParmIdFromName);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("GetParmIntValue","session","nodeId","parmName","index","value"),&HAPI::GetParmIntValue);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("GetParmNodeValue","session","nodeId","parmName","value"),&HAPI::GetParmNodeValue);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("GetParmStringValue","session","nodeId","parmName","index","evaluate","value"),&HAPI::GetParmStringValue);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("GetStatus","session","statusType","status"),&HAPI::GetStatus);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("GetStatusString","session","statusType"),&HAPI::GetStatusString);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("GetString","session","stringHandle"),&HAPI::GetString);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("Initialize","session","cookOptions","useCookingThread","cookingThreadStackSize","houdiniEnvironmentFiles","otlSearchPath","dsoSearchPath","imageDsoSearchPath","audioDsoSearchPath"),&HAPI::Initialize);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("Interrupt","session"),&HAPI::Interrupt);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("IsInitialized","session"),&HAPI::IsInitialized);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("IsNodeValid","session","nodeId","uniqueNodeId","answer"),&HAPI::IsNodeValid);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("LoadAssetLibraryFromFile","session","filePath","allowOverwrite","assetId"),&HAPI::LoadAssetLibraryFromFile);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("LoadAssetLibraryFromMemory","session","buffer","allowOverwrite", "assetId"),&HAPI::LoadAssetLibraryFromMemory);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("LoadGeoFromFile","session","nodeId","filePath"),&HAPI::LoadGeoFromFile);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("LoadGeoFromMemory","session","nodeId","format","buffer"),&HAPI::LoadGeoFromMemory);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("LoadHIPFile","session","filePath","cookOnLoad"),&HAPI::LoadHIPFile);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("LoadNodeFromFile","session","fileName","parentId","nodeLabel","cookOnLoad","newNodeId"),&HAPI::LoadNodeFromFile);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("MaterialInfo_Create"),&HAPI::MaterialInfo_Create);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("NodeInfo_Create"),&HAPI::NodeInfo_Create);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("ObjectInfo_Create"),&HAPI::ObjectInfo_Create);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("ParmInfo_Create"),&HAPI::ParmInfo_Create);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("PartInfo_Create"),&HAPI::PartInfo_Create);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("SessionInfo_Create"),&HAPI::SessionInfo_Create);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("RemoveCustomString","session","stringHandle"),&HAPI::RemoveCustomString);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("RenameNode","session","nodeId","newName"),&HAPI::RenameNode);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("RevertGeo","session","nodeId"),&HAPI::RevertGeo);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("RevertParmToDefault","session","nodeId","parmName","index"),&HAPI::RevertParmToDefault);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("RevertParmToDefaults","session","nodeId","parmName"),&HAPI::RevertParmToDefaults);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("SaveGeoToFile","session","nodeId","filePath"),&HAPI::SaveGeoToFile);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("SaveToHip","session","filename"),&HAPI::SaveToHip);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("SetCustomString","session","string_value","handle_value"),&HAPI::SetCustomString);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("SetAttributeFloatData","session","nodeId","partId","name","attrInfo","dataArray","start","length"),&HAPI::SetAttributeFloatData);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("SetAttributeIntData","session","nodeId","partId","name","attrInfo","dataArray","start","length"),&HAPI::SetAttributeIntData);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("SetAttributeStringData","session","nodeId","partId","name","attrInfo","dataArray","start","length"),&HAPI::SetAttributeStringData);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("SetCurveCounts","session","nodeId","partId","curveCounts","start","length"),&HAPI::SetCurveCounts);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("SetCurveInfo","session","nodeId","partId","curveInfo"),&HAPI::SetCurveInfo);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("SetCurveKnots","session","nodeId","partId","knots","start","length"),&HAPI::SetCurveKnots);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("SetCurveOrders","session","nodeId","partId","orders","start","length"),&HAPI::SetCurveOrders);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("SetFaceCounts","session","nodeId","partId","faceCounts","start","length"),&HAPI::SetFaceCounts);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("SetInputCurveInfo","session","nodeId","partId","curveInfo"),&HAPI::SetInputCurveInfo);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("SetInputCurvePositions","session","nodeId","partId","positions","start","length"),&HAPI::SetInputCurvePositions);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("SetNodeDisplay","session","nodeId","onOff"),&HAPI::SetNodeDisplay);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("SetObjectTransform","session","nodeId","transform"),&HAPI::SetObjectTransform);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("SetServerEnvInt","session","envName","value"),&HAPI::SetServerEnvInt);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("SetServerEnvString","session","envName","value"),&HAPI::SetServerEnvString);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("SetSessionSync","session","enable"),&HAPI::SetSessionSync);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("SetSessionSyncInfo","session","syncInfo"),&HAPI::SetSessionSyncInfo);
        godot::ClassDB::bind_static_method("HoudiniEngine",godot::D_METHOD("SaveNodeToFile","session","nodeId","fileName"),&HAPI::SaveNodeToFile);
    }
public:
