...
class HEGHdaResource : public godot::Resource{
    GDCLASS(HEGHdaResource,godot::Resource)
    static void _bind_methods(){
        godot::ClassDB::bind_method(godot::D_METHOD("get_path"),&HEGHdaResource::get_path);
        godot::ClassDB::bind_method(godot::D_METHOD("set_path","path"),&HEGHdaResource::set_path);
        godot::ClassDB::add_property("HEGHdaResource",godot::PropertyInfo(godot::Variant::STRING,"path",godot::PROPERTY_HINT_FILE,"*.hda,*.otl"),"set_path","get_path");
        godot::ClassDB::bind_method(godot::D_METHOD("get_assetId"),&HEGHdaResource::get_assetId);
        godot::ClassDB::add_property("HEGHdaResource",godot::PropertyInfo(godot::Variant::INT,"assetId",godot::PROPERTY_HINT_NONE,"",godot::PROPERTY_USAGE_READ_ONLY),godot::StringName(),"get_assetId");
    }
...
class HEGHdaImporter : public godot::EditorImportPlugin{
    GDCLASS(HEGHdaImporter,godot::EditorImportPlugin)
    static void _bind_methods(){}
public:
...
class HEGHipResource : public godot::Resource{
    GDCLASS(HEGHipResource,godot::Resource)
    static void _bind_methods(){
        godot::ClassDB::bind_method(godot::D_METHOD("get_path"),&HEGHipResource::get_path);
        godot::ClassDB::bind_method(godot::D_METHOD("set_path","path"),&HEGHipResource::set_path);
        godot::ClassDB::add_property("HEGHipResource",godot::PropertyInfo(godot::Variant::STRING,"path",godot::PROPERTY_HINT_FILE,"*.hip"),"set_path","get_path");
    }
    godot::String get_path(){
        return godot::String::utf8(path.c_str());
    }
...
class HEGHipImporter : public godot::EditorImportPlugin{
    GDCLASS(HEGHipImporter,godot::EditorImportPlugin)
    static void _bind_methods(){}
public:
    godot::String _get_importer_name()const override{
...
class HEGImportPlugin : public godot::EditorPlugin{
    GDCLASS(HEGImportPlugin,godot::EditorPlugin)
    static void _bind_methods(){}
    godot::Ref<HEGHdaImporter> HDA_importer;
    godot::Ref<HEGHipImporter> HIP_importer;
public:
