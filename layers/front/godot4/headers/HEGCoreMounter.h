...
class HEGCoreMountPlugin : public godot::EditorPlugin{
    GDCLASS(HEGCoreMountPlugin,godot::EditorPlugin)
    static void _bind_methods(){}
public:
    void _enter_tree() override {
        godot::UtilityFunctions::print("[Houdini Engine] EditorPlugin loaded, start to init HEGCenter.");
